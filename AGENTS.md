...
- `AGENT_PATHS`: Maps agent types to their install directories (e.g., `github-copilot` → `.agents/skills`, `Codex` → `.Codex/skills`)
...
- `skillbox.defaultAgent`: Target agent for installations (github-copilot, Codex, cursor, etc.)
